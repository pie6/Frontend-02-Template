...
/******/ 	return __webpack_require__(__webpack_require__.s = "./2/2-index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _framework__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./framework */ "./2/framework.js");
/* harmony import */ var _7_gesture_encapsulation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./7-gesture-encapsulation */ "./2/7-gesture-encapsulation.js");
/* harmony import */ var _4_animation_delay__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./4-animation-delay */ "./2/4-animation-delay.js");
/* harmony import */ var _4_timingFunction__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./4-timingFunction */ "./2/4-timingFunction.js");
...
var Carousel = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Carousel, [{
    ...
    value: function render() {
      ...
      var _iterator = _createForOfIteratorHelper(this[_framework__WEBPACK_IMPORTED_MODULE_0__["ATTRIBUTE"]].src),
          _step;
      ...
      var t = 0;
      var handler = null;
      this[_framework__WEBPACK_IMPORTED_MODULE_0__["STATE"]].position = 0; // Animation 產生的距離
      ...
      this.root.addEventListener("tap", function (e) {
        _this.triggerEvent("click", {
          data: _this[_framework__WEBPACK_IMPORTED_MODULE_0__["ATTRIBUTE"]].src[_this[_framework__WEBPACK_IMPORTED_MODULE_0__["STATE"]].position],
          position: _this[_framework__WEBPACK_IMPORTED_MODULE_0__["STATE"]].position
        });
      });
      this.root.addEventListener("pan", function (e) {
        var x = e.clientX - e.startX - ax;
        var current = _this[_framework__WEBPACK_IMPORTED_MODULE_0__["STATE"]].position - (x - x % imgW) / imgW;
      ...
      this.root.addEventListener("end", function (e) {
        ...
        _this[_framework__WEBPACK_IMPORTED_MODULE_0__["STATE"]].position = _this[_framework__WEBPACK_IMPORTED_MODULE_0__["STATE"]].position - (x - x % 500) / 500 - direction;
        _this[_framework__WEBPACK_IMPORTED_MODULE_0__["STATE"]].position = (_this[_framework__WEBPACK_IMPORTED_MODULE_0__["STATE"]].position % children.length + children.length) % children.length;
      ...
      var nextPicture = function nextPicture() {
        ...
        var nextIndex = (_this[_framework__WEBPACK_IMPORTED_MODULE_0__["STATE"]].position + 1) % children.length;
        var current = children[_this[_framework__WEBPACK_IMPORTED_MODULE_0__["STATE"]].position];
        var next = children[nextIndex]; // Animation 產生的距離

        t = Date.now();
        timeline.add(new _4_animation_delay__WEBPACK_IMPORTED_MODULE_2__["Animation"](current.style, "transform", -_this[_framework__WEBPACK_IMPORTED_MODULE_0__["STATE"]].position * 500, -500 - _this[_framework__WEBPACK_IMPORTED_MODULE_0__["STATE"]].position * 500, 500, 0, _4_timingFunction__WEBPACK_IMPORTED_MODULE_3__["ease"], function (v) {
          return "translateX(".concat(v, "px)");
        }));
        ...
        _this[_framework__WEBPACK_IMPORTED_MODULE_0__["STATE"]].position = nextIndex;
      };
...
var a = Object(_framework__WEBPACK_IMPORTED_MODULE_0__["createElement"])(Carousel, {
  ...
  onChange: function onChange(e) {
    return console.log(e.detail.position);
  },
  onClick: function onClick(e) {
    return location.href = e.detail.data.url;
  }
});
...
/* harmony import */ var _4_timingFunction__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./4-timingFunction */ "./2/4-timingFunction.js");
function _createForOfIteratorHelper(o, allowArrayLike) { var it; if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = o[Symbol.iterator](); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
